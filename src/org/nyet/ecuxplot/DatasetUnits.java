...
public class DatasetUnits {
    ...
    private static Dataset.Column createConvertedColumn(Dataset dataset, Dataset.Column baseColumn,
        ...
        // Preserve id_orig (original field name) from base column when creating converted column
        String id_orig = baseColumn.getIdOrig();
        return dataset.new Column(columnId, id_orig, targetUnit, convertedData, columnType);
    }
